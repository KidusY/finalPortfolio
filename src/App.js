		...
		<div className="App">
			...
			<div className="contact" id="#contact">
				...
				<br />
					...
					<p> It doesn't matter if its a small project or you want 
					to hire me full time, do be shy shoot me an email at <a  href="mailto:kidusyilma@gmail.com">kidusyilma@gmail.com </a> 
					or better yet, fill out the contact form </p>
